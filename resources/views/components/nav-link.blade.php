...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-4 py-3 bg-blue-50 border-l-4 border-[--color-1] text-sm font-medium text-[--color-1] focus:outline-hidden transition duration-150 ease-in-out'
