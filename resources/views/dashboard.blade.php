        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <p class="text-lg font-semibold mb-4">Welcome to School Management System</p>
                    <p class="text-gray-600">You're logged in! Use the navigation to manage students, assessments, and other school activities.</p>
                </div>
            </div>
        </div>
    </div>
